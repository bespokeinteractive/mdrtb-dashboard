	...
	<section>
		...
		<fieldset id="visit-description">
			...
			<field>
				...
				<div id="regimenTypeField"></div>
			</field>
			
			<field class="regimen">
				<label for="regimenName">
					Specify :
					<span class="mandatory"></span>
				</label>
				<input id="regimenName" class="" name="regimen.name" type="text" placeholder="Specify Regimen">
			</field>
